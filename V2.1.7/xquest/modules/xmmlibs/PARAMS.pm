...
sub triple {
	my $self = shift;
	unless ( defined( $self->params->{'tripleshift'} ) ) {
		die "parameter tripleshift is not defined $!";
	}
	my @shifts = split /,/, $self->params->{'tripleshift'};
	return \@shifts;
}
...
sub highresms2{
my $self = shift;
return $self->params->{'highresolutionms2'};
}
...
sub Triplepair_Mr_tolerance {
	my $self = shift;
	unless ( defined( $self->params->{'Triplepair_Mr_tolerance'} ) ) {
		die "parameter Triplepair_Mr_tolerance is not defined $!";
	}
	return $self->params->{'Triplepair_Mr_tolerance'};
}
...
sub Triplepair_Tr_tolerance {
	my $self = shift;
	unless ( defined( $self->params->{'Triplepair_Tr_tolerance'} ) ) {
		die "parameter Triplepair_Tr_tolerance is not defined $!";
	}
	return int( $self->params->{'Triplepair_Tr_tolerance'} * 60 );
}
