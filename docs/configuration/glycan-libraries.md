...
Source files live under `databases/` (`Nglyc309_Byonic.glyc`, `Oglyc78_Byonic.glyc`) and are converted at load time using `glycan_residues.txt` and `diagnostic_ion_catalog.txt`.
...
- [Diagnostic ions](../science/diagnostic-ions.md)
